...
const CACHE = 'cc-shell-v76';
const SHELL = [
  '.', 'index.html',
  'css/theme.css', 'css/layout.css', 'css/mission.css', 'css/mobile.css', 'css/tablet.css', 'css/enhance.css', 'css/cinema.css', 'css/email.css', 'css/noir.css', 'css/deck.css', 'css/board.css', 'css/calendar.css', 'css/dailies.css',
  'js/mission.js', 'js/globe.js', 'js/deck.js', 'js/effects.js', 'js/weather.js', 'js/panels.js', 'js/mobile.js', 'js/sniper-x.js', 'js/cinema.js', 'js/backdrop.js', 'js/saber.js', 'js/enhance.js', 'js/email.js', 'js/gmail.js', 'js/hal.js', 'js/noir.js', 'js/app.js', 'js/board.js', 'js/bills.js', 'js/dailies.js', 'js/auth.js', 'js/supabase.js', 'js/config.js',
